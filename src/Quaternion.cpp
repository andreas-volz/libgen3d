#include "../include/libgen3d/Quaternion.h"
...
Quaternion Gen3D::operator * (const Quaternion &q1, const Quaternion &q2)
{
  Quaternion q;
...
std::ostream &Gen3D::operator << (std::ostream &s, const Quaternion &q)
{
  s << "[";
