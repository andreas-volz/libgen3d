#include "../include/libgen3d/Matrix.h"
...
Vector3f Gen3D::operator * (const Vector3f &v, const Matrix &m)//REDO
{
...
Matrix Gen3D::operator * (const Matrix &a, const Matrix &b)
{
  Matrix r;
...
std::ostream &Gen3D::operator << (std::ostream &s, const Matrix& m)
{
  for (int i = 0; i < 4; i++)
  {
    s << "[";
